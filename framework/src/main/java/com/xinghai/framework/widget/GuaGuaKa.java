package com.xinghai.framework.widget;
...
//		super.onMeasure(widthMeasureSpec, heightMeasureSpec);
		...
		switch (widthMode){
			...
			case MeasureSpec.UNSPECIFIED:
				width = (getPaddingLeft() == 0 ? 60 : getPaddingLeft())
						+ mTextBound.width()
						+ (getPaddingRight() == 0 ? 60 : getPaddingRight());
				break;
		}
		...
		switch (heightMode){
			...
			case MeasureSpec.AT_MOST:
			case MeasureSpec.UNSPECIFIED:
				height = (getPaddingTop() == 0 ? 60 : getPaddingTop())
						+ mTextBound.height()
						+ (getPaddingBottom() == 0 ? 60 : getPaddingBottom());
				break;
		}
